...
public class VibrationPlugin implements FlutterPlugin {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        final VibrationMethodChannelHandler methodChannelHandler = new VibrationMethodChannelHandler(new Vibration(vibrator, flutterPluginBinding.getApplicationContext()));
